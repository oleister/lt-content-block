            ...
            for (let i in trips.products) {
                content+= '<table align="left" border="0" cellpadding="8" cellspacing="0" style="width:100%;">
   				<tr>
   					...
   					<td style="background-color: rgb(246, 140, 18);"><span style="font-family:arial,helvetica,sans-serif;"><span style="font-size:14px;">Ihr Hotel in ${trips.products[i].hotel.city.name} ist ${trips.products[i].hotel.name} der Kategorie ${trips.products[i].hotel.category}&nbsp;</span></span>
					</td></tr><tr>
